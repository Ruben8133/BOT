...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=W6gGmY5Q#kkXwqm7YuHSEZf0Wq1KRt8ficpFSmwKgnmj4ZvoosBE' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SESSION_NAME: process.env.PORT === undefined ? "✞︎ 𝙺𝙰𝙺𝙰𝚂𝙷𝙸 ✞︎" : process.env.SESSION_NAME,
